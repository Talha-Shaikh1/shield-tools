          ...
          <div className="border-b border-slate-200 bg-white px-4 py-4 shadow-xl dark:border-slate-800 dark:bg-slate-950 md:hidden animate-in slide-in-from-top-2">
            <div className="flex flex-col gap-2">
              ...
              <div className="pt-2 flex flex-col gap-2">
                <InstallAppButton variant="primary" className="w-full justify-center" />
                <button
                  onClick={() => {
                    setMobileMenuOpen(false);
                    setIsEmbedOpen(true);
                  }}
                  className="flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-slate-50 py-2.5 text-xs font-semibold text-slate-700 hover:bg-slate-100 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200"
                >
                  <Code2 className="h-4 w-4 text-blue-500" />
